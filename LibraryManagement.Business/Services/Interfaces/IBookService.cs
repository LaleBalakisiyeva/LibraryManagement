...
namespace LibraryManagement.Business.Services.Interfaces
{
    public interface IBookService
    {
        ...
        Task<PaginatedResult<BookDto>> GetAllPagedAsync(int pageNumber, int pageSize, string? sortBy, bool isDescending, string? searchTerm = null, int? authorId = null, int? minYear = null, int? maxYear = null);
