...
namespace LibraryManagement.Tests
{
    public class BookServiceTests
    {
        ...
        private readonly Mock<IValidator<BookCreateDto>> _mockValidator;
        ...
        public BookServiceTests()
        {
            ...
            _mockValidator = new Mock<IValidator<BookCreateDto>>();
        ...
        public async Task CreateAsync_ShouldCallUnitOfWorkSave()
        {
            ...
            _mockValidator.Setup(v => v.ValidateAsync(It.IsAny<BookCreateDto>(), default))
